...
const ProductDetails = () => {
  ...
  // Set thumbnail on product change
  useEffect(() => {
  ...
  if (!product) return <p className="mt-16 text-center">Product not found</p>;
    ...
    <div className="mt-12 px-6 md:px-16 lg:px-24 xl:px-32">
      ...
      {/* Related Products */}
        <div className="flex flex-col items-center mt-20">
          ...
          <div className="flex flex-wrap justify-center gap-3 md:gap-6 mt-6 w-full">
